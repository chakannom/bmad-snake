...
export const mountGameUI = (
  ...
  app.innerHTML = `
    <main class="layout">
      ...
      <section class="touch-controls" aria-label="모바일 컨트롤">
        ...
        <button type="button" class="control-btn restart" id="restart-btn" aria-label="재시작">RESTART</button>
  ...
  if (!canvas || !stageEl || !mapNameEl || !scoreEl || !totalScoreEl || !timerEl || !speedEl || !statusEl || !restartButton) {
